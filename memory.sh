...
test_commands[4]="./mem_fail -f./f -aalias2 -e0123456789"
test_commands[5]="./mem_fail -f./f -aalias2 -e -mman"
test_commands[6]="./mem_fail -f./f -aalias2 -e -m -L18"
...
test_commands[14]="./mem_fail -f./f -aalias2 -Ltw"
